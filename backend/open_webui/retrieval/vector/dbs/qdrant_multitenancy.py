...
class QdrantClient(VectorDBBase):
    ...
    def _get_collection_and_tenant_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current AuraPro naming conventions for
        collection names. If AuraPro changes how it generates collection names
            (e.g., "user-memory-" prefix, "file-" prefix, or hash
