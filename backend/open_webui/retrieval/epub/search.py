...
class ConceptTermMatcher:
    ...
    def match_spans(
        ...
        alias ``锚`` is boundary-valid on its own but is covered by the longer
        ``枢对锚站的校验``, and a reader asking about the trial of Job is not
    ...
    def _valid_boundaries(
        ...
        # lands inside the name `锚点`, pulling in concepts the query never
