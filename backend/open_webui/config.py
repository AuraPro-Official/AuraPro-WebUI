...
if VECTOR_DB == 'chroma':
    # Match Chroma's stable defaults without importing the full client at
    # application startup. The driver is loaded by LazyVectorDBClient when
    # RAG or memory search is first used.
...
RAG_EMBEDDING_MODEL_TRUST_REMOTE_CODE = os.getenv('RAG_EMBEDDING_MODEL_TRUST_REMOTE_CODE', 'False').lower() == 'true'
...
RAG_RERANKING_MODEL_TRUST_REMOTE_CODE = os.getenv('RAG_RERANKING_MODEL_TRUST_REMOTE_CODE', 'False').lower() == 'true'
...
AURAPRO_SHERPA_AUDIO_BASE_URL = (
    os.getenv(
        'AURAPRO_SHERPA_AUDIO_BASE_URL',
        os.getenv('SHERPA_AUDIO_BASE_URL', 'http://127.0.0.1:39384/v1'),
    )
    .strip()
    .rstrip('/')
)
if AURAPRO_SHERPA_AUDIO_BASE_URL and not AURAPRO_SHERPA_AUDIO_BASE_URL.endswith('/v1'):
    AURAPRO_SHERPA_AUDIO_BASE_URL = f'{AURAPRO_SHERPA_AUDIO_BASE_URL}/v1'

AURAPRO_SHERPA_API_KEY = os.getenv('AURAPRO_SHERPA_API_KEY', 'aurapro-local')
...
AUDIO_STT_OPENAI_API_BASE_URL = os.getenv('AUDIO_STT_OPENAI_API_BASE_URL', AURAPRO_SHERPA_AUDIO_BASE_URL)

AUDIO_STT_OPENAI_API_KEY = os.getenv('AUDIO_STT_OPENAI_API_KEY', AURAPRO_SHERPA_API_KEY)

AUDIO_STT_OPENAI_API_REQUEST_FORMAT = os.getenv('AUDIO_STT_OPENAI_API_REQUEST_FORMAT', 'multipart')

AUDIO_STT_ENGINE = os.getenv('AUDIO_STT_ENGINE', 'sherpa')

AUDIO_STT_MODEL = os.getenv('AUDIO_STT_MODEL', 'sherpa-asr')
...
AUDIO_TTS_OPENAI_API_BASE_URL = os.getenv('AUDIO_TTS_OPENAI_API_BASE_URL', AURAPRO_SHERPA_AUDIO_BASE_URL)
AUDIO_TTS_OPENAI_API_KEY = os.getenv('AUDIO_TTS_OPENAI_API_KEY', AURAPRO_SHERPA_API_KEY)
...
AUDIO_TTS_ENGINE = os.getenv('AUDIO_TTS_ENGINE', 'sherpa')


AUDIO_TTS_MODEL = os.getenv('AUDIO_TTS_MODEL', 'sherpa-tts')

AUDIO_TTS_VOICE = os.getenv('AUDIO_TTS_VOICE', '0')
...
CORS_ALLOW_ORIGIN = [origin for origin in os.getenv('CORS_ALLOW_ORIGIN', '').split(';') if origin]
...
CORS_ALLOW_CUSTOM_SCHEME = [scheme for scheme in os.getenv('CORS_ALLOW_CUSTOM_SCHEME', '').split(';') if scheme]
...
CONTEXT_COMPACTION_THRESHOLD_PERCENT = int(os.getenv('CONTEXT_COMPACTION_THRESHOLD_PERCENT', '75'))
...
DEFAULT_CONFIG = {
    ...
    'chat.context_compaction.threshold_percent': CONTEXT_COMPACTION_THRESHOLD_PERCENT,
