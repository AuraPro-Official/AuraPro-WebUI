...
class BatchPipeline:
    ...
    def create_openai_batch_jsonl(
        passages: List[Dict[str, Any]], output_filepath: str, model: str = 'gpt-4o-mini'
    ) -> str:
        """
    ...
    @staticmethod
    def ingest_openai_batch_results(
        result_jsonl_filepath: str, passages_map: Dict[str, Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
