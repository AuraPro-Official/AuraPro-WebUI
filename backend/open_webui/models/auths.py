...
# whether an account exists (CWE-208). Keeping it constant avoids an
# expensive bcrypt key derivation during every backend start.
PLACEHOLDER_HASH = '$2b$12$DCmQYewIxBC6qoNurdPjmuVZvrf3XdwfHYwFyg0yPRtzCsVhZJMEq'
...
class AuthsTable:
    ...
    async def authenticate_user(
        ...
        log.debug('Password authentication attempt')
    ...
    async def authenticate_user_by_email(
        ...
        log.debug('Trusted-email authentication attempt')
