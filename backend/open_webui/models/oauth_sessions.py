...
class OAuthSessionTable:
    def __init__(self):
        ...
        try:
            ...
            log.error(
                'Error initializing Fernet with provided key (%s)',
                type(e).__name__,
            )
            raise
    ...
    def _encrypt_token(self, token) -> str:
        ...
        try:
            ...
            log.error('Error encrypting tokens (%s)', type(e).__name__)
            raise
    ...
    def _decrypt_token(self, token: str):
        ...
        try:
            ...
            log.error('Error decrypting tokens (%s)', type(e).__name__)
            raise
    ...
    async def update_session_by_id(
        ...
        try:
            ...
            log.error('Error updating OAuth session tokens (%s)', type(e).__name__)
            return None
