...
from open_webui.socket.cors import resolve_socketio_cors_origins
...
# An empty HTTP CORS list means same-origin only. Socket.IO uses None for that
# behavior; passing [] would disable its Origin validation entirely.
SOCKETIO_CORS_ORIGINS = resolve_socketio_cors_origins(CORS_ALLOW_ORIGIN)
