...
- **Next action:** Execute T-110 to validate the Desktop-managed path with no external end-user installation. The real local-book E2E is recorded above; do not send the book to a cloud Batch provider until an administrator explicitly configures and authorizes that offline run.
